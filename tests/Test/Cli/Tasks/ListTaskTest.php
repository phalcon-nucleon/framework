    ...
    public function testMainAction()
    {
        $expected = [
            'write'  => ['exactly' => 19, 'consecutive' => [
                ...
                // assets
                [' ' . Decorate::info('assets:js') . '              Compilation, Optimization, Minification des assets js. Utilise l\'api Closure Compiler.                    ', true],
                [' ' . Decorate::info('assets:sass') . '            Compilation des assets sass. Execute la commande : sass resources/assets/scss/app.scss public/css/app.css ', true],
                //['config', true],
